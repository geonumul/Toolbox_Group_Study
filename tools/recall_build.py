...
def _eco():
    ...
    return {
        ...
        "unit_pages": {"E1": {"w1-1": [1, 2], "w1-2": [3, 15], "w1-3": [16, 18], "w1-4": [19, 25], "w1-5": [26, 26],
                       ...
                       # 2강 정리 슬라이드 단원이 다루는 쪽 (build_slides_w3.py 의 단원과 같이 고친다)
                       "E2": {"w3-1": [1, 4], "w3-2": [5, 7], "w3-3": [8, 11], "w3-4": [12, 14], "w3-5": [15, 15],
                              "w3-6": [16, 27], "w3-7": [28, 29], "w3-8": [30, 32], "w3-9": [33, 44],
                              "w3-10": [45, 49], "w3-11": [50, 55]}},
