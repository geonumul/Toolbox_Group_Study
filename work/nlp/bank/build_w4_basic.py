...
calc(U3, "N4 p.22", "attention-softmax",
     ...
     ["$\\mathrm{softmax}(e)_i = \\exp(e_i) / \\sum_j \\exp(e_j)$ 예요",
      ...
      "$7.389 / 11.107 \approx 0.6652$ (준 어림값으로 나누면 0.66526 이라 0.6653 으로 써도 정답이에요. 어림 없이 계산한 정확한 값이 0.66524 라서 0.6652 로 적어 둡니다)",
...
calc(U5, "N4 p.37", "attention-shapes",
     ...
     [{"label": "QK^T 의 행", "ans": 6}, {"label": "QK^T 의 열", "ans": 6},
      {"label": "A 의 행", "ans": 6}, {"label": "A 의 열", "ans": 6},
     ...
     "$QK^{\\top}$ 는 6 x 6, $A$ 도 6 x 6, $O$ 는 6 x 4",
